...
<div class="mobile-sidebar d-block d-lg-none" id="mobile-sidebar">
    <div class="logo-m">
        <a href="index"><img src="{{ asset('storage/' . getSettingValue('logo_white')) }}" width="80"
                height="80" alt="" /></a>
    </div>
    ...
    <div class="mobile-nav">
        ...
        <a href="account" class="theme-btn8">Activate Your eSim</a>
        ...
        <div class="contact-infos">
            ...
            <div class="box">
                ...
                <div class="pera">
                    <a href="tel:{{ getSettingValue('site_phone') }}">{{ getSettingValue('site_phone') }}</a>
                </div>
            </div>
            <div class="box">
                <div class="icon">
                ...
                <div class="pera">
                    <a href="mailto:{{ getSettingValue('site_email') }}">{{ getSettingValue('site_email') }}</a>
                </div>
            </div>
        </div>
        ...
        <div class="contact-infos">
            ...
            <ul class="icon-list">
                @if (getTable('socials'))
                    @foreach (getTables('socials') as $social)
