    ...
    <div class="checkout-container">
        ...
        <div class="checkout-body">
            <div class="note-container">
                <p>ملاحظة :</p>
                <ul>
                    <li>في السحب كاش، نحن لا نتعامل مع طرف ثالث، يرجى حضورك شخصيا عند الإستلام
                    </li>
                </ul>
            </div>

            <form id="payment-form" action="{{ route('process.saveCashTransfer.withdrawal') }}" method="post">
                @csrf
