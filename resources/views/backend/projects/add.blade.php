                ...
                <div class="col-12">
                    ...
                    <div class="block my-4">
                        <div class="block-content">
                            <h5 class="block-title">General Information</h5>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="location" name="location"
                                               placeholder="Select location from the map" readonly required>
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#mapModal">Select from Map
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="block my-4">
                        <div class="block-content">
                            <h5 class="block-title">Facilities and Distances</h5>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="facility" name="facilities[]" required>
                                        ...
                                        @foreach ($facilities as $facility)
                                            <option
                                                value="{{ htmlspecialchars($facility['id']) }}">{{ htmlspecialchars($facility['name']) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="distance" class="form-label">Distance (km)</label>
                                    <input type="number" class="form-control" id="distance" name="distances[]"
                    ...
                    <div class="block my-4">
                        <div class="block-content">
                            <h5 class="block-title">Custom Fields</h5>
                            <div id="custom-fields" class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="customName1" class="form-label">Field Name</label>
                                    <input type="text" class="form-control" id="customName1" name="custom_field_names[]"
                                           placeholder="Enter name" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="customValue1" class="form-label">Field Value</label>
                                    <input type="text" class="form-control" id="customValue1"
                                           name="custom_field_values[]" placeholder="Enter value" required>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-secondary mx-2" id="add-custom-field">Add Field
                                </button>
                    ...
                    <div class="block my-4">
                        <div class="block-content">
                            <h5 class="block-title">Video Links</h5>
                            <div id="video-links" class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="videoLink1" class="form-label">Video Link</label>
                                    <input type="url" class="form-control" id="videoLink1" name="video_links[]"
                        ...
                        <div class="block-content">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="specialityVideo" name="speciality_video"
                                           placeholder="Enter speciality video" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="detailedVideo" class="form-label">Detailed video</label>
                                    <input type="text" class="form-control" id="detailedVideo" name="detailed_video"
    ...
    <script>
        ...
        document.getElementById('add-facility-field').addEventListener('click', function () {
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select" id="facility${fieldCount}" name="facilities[]"
                 required>
                    <option value="" disabled selected>Select a facility</option>
                    @foreach ($facilities as $facility)
        ...
        <div class="col-md-6 mb-3">
            <label for="distance${fieldCount}" class="form-label">Distance (km)</label>
                <input type="number" class="form-control" id="distance${fieldCount}" name="distances[]" placeholder="Enter distance" required>
            </div>
        `;
        ...
        document.getElementById('add-video-link').addEventListener('click', function () {
            ...
            <div class="col-md-12 mb-3">
                ...
                <input type="url" class="form-control" id="videoLink${videoCount}" name="video_links[]" placeholder="Enter video link" required>
            </div>
        `;
