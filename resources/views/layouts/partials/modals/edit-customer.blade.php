<div class="modal fade" id="customer-edit_add-modal-{{$i->id}}" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control"  value="{{$i->email}}"name="email">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label">{{__('messages.phone')}}  {{ required() }}</label>
                                <input type="text" class="form-control" value="{{$i->phone}}" name="phone" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label">{{__('messages.birth')}}</label>
                                <input type="date" class="form-control" value="{{$i->birth}}" name="birth">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-label">{{__('messages.adresse')}}</label>
                                <input type="text" class="form-control" value="{{$i->adress}}" name="adress">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="gender" class="form-control" required>
                                    @foreach (gender() as $gender)
                                        <option @if($i->gender == $gender) selected @endif value="{{ $gender }}">{{ $gender }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="blood" class="form-control">
                                    @foreach (blood() as $blood)
                                        <option @if($i->blood == $blood) selected @endif value="{{ $blood }}">{{ $blood }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$i->weight}}" name="weight">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{$i->height}}" name="height">
                            </div>
                        </div>
                    </div>
