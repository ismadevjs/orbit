    ...
    <div class="login-wrapper">
        ...
        <div class="login-left">
            ...
            <div class="form-container">
                <h2 class="form-title">تأكيد رمز OTP</h2>
                <p class="form-subtitle">أدخل رمز OTP المرسل إلى بريدك الإلكتروني</p>
                ...
                <form method="POST" action="{{ route('otp.verify') }}">
                    ...
                    <div class="form-group mb-3">
                        <input type="text" class="form-control" id="otp" name="otp"
                               placeholder="رمز OTP" required autofocus>
                        <x-input-error :messages="$errors->get('otp')" class="mt-1 text-danger text-sm"/>
                    </div>
                    ...
                    <p class="text-center mt-3">
                        <span class="text-dark">لم تتلق الرمز؟ </span>
                        <a href="{{ route('otp.resend') }}" class="link">إعادة إرسال OTP</a>
                    </p>
                </form>
            </div>
        </div>
